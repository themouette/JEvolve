<div class='page_content'>
    ...
    <div class="info-box">
        ...
        <div class="nav-bar">
            ...
            {/if}
            {if $children}
                <a href="#sec-descendents" rel='subsection'>Descendents</a>
                {if $vars || $ivars || $methods || $imethods || $consts || $iconsts}|{/if}
            {/if}
            {if $vars || $ivars}
                {if $vars}
                    <a href="#sec-var-summary" rel='subsection'>Vars</a> (<a href="#sec-vars">details</a>)
                {else}
                    <a href="#sec-vars" rel='subsection'>Vars</a>
                {/if}
                {if $methods || $imethods}|{/if}
            {/if}
            {if $methods || $imethods}
                {if $methods}
                    <a href="#sec-method-summary" rel='subsection'>Methods</a> (<a href="#sec-methods" rel='subsection'>details</a>)
                {else}
                    <a href="#sec-methods" rel='subsection'>Methods</a>
                {/if}			
            {/if}
            {if $consts || $iconsts}
                {if $consts}
                    <a href="#sec-const-summary" rel='subsection'>Constants</a> (<a href="#sec-consts">details</a>)
                {else}
                    <a href="#sec-consts" rel='subsection'>Constants</a>
                {/if}			
            {/if}
        </div>
        <div class="info-box-body">
            ...
            <p class="notes">
                Located in <a class="field" href="{$page_link}" rel='contents'>{$source_location}</a> (line <span class="field">{if $class_slink}{$class_slink}{else}{$line_number}{/if}</span>)
            </p>
    ...
    {if $children}
        ...
        <div class="info-box">
            ...
            <div class="nav-bar">
                <a href="#sec-description" rel='subsection'>Description</a> |
                <span class="disabled">Descendents</span>
                {if $vars || $ivars || $methods || $imethods || $consts || $iconsts}|{/if}
                {if $vars || $ivars}
                    {if $vars}
                        <a href="#sec-var-summary" rel='subsection'>Vars</a> (<a href="#sec-vars" rel='subsection'>details</a>)
                    {else}
                        <a href="#sec-vars" rel='subsection'>Vars</a>
                    {/if}
                    {if $methods || $imethods}|{/if}
                ...
                {if $methods || $imethods}
                    {if $methods}
                        <a href="#sec-method-summary" rel='subsection'>Methods</a> (<a href="#sec-methods">details</a>)
                    {else}
                        <a href="#sec-methods" rel='subsection'>Methods</a>
                    {/if}			
                {/if}
            ...
            <div class="info-box-body">			
                <div class="method-summary">
                    ...
                    <div class="method-definition">
                        ...
                        static
                        <a href="#{$methods[methods].function_name}" title="details" class="method-name" rel='subsection'>{if $methods[methods].ifunction_call.returnsref}&amp;{/if}{$methods[methods].function_name}</a>
