...
" rel='contents'><img src="<?php echo $this->_tpl_vars['subdir']; ?>
images/previous_button.png" alt="Previous"></a>
			<?php else: ?>
				<span class="disabled"><img src="<?php echo $this->_tpl_vars['subdir']; ?>
images/previous_button_disabled.png" alt="Previous"></span>
			<?php endif; ?>
		</td>
...
" rel='contents'><img src="<?php echo $this->_tpl_vars['subdir']; ?>
images/next_button.png" alt="Next"></a>
			<?php else: ?>
				<span class="disabled"><img src="<?php echo $this->_tpl_vars['subdir']; ?>
images/next_button_disabled.png" alt="Next"></span>
			<?php endif; ?>
		</td>
	</tr>
	<tr>
